// Generated by gencpp from file px4_uwb/Bspline.msg
// DO NOT EDIT!


#ifndef PX4_UWB_MESSAGE_BSPLINE_H
#define PX4_UWB_MESSAGE_BSPLINE_H
...
struct Bspline_
{
  ...
  typedef boost::shared_ptr< ::px4_uwb::Bspline_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::px4_uwb::Bspline_<ContainerAllocator> const> ConstPtr;

}; // struct Bspline_

typedef ::px4_uwb::Bspline_<std::allocator<void> > Bspline;

typedef boost::shared_ptr< ::px4_uwb::Bspline > BsplinePtr;
typedef boost::shared_ptr< ::px4_uwb::Bspline const> BsplineConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::px4_uwb::Bspline_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::px4_uwb::Bspline_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::px4_uwb::Bspline_<ContainerAllocator1> & lhs, const ::px4_uwb::Bspline_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::px4_uwb::Bspline_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_uwb::Bspline_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::px4_uwb::Bspline_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::px4_uwb::Bspline_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_uwb::Bspline_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_uwb::Bspline_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::px4_uwb::Bspline_<ContainerAllocator> >
{
  ...
  static const char* value(const ::px4_uwb::Bspline_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4f7510f7be6fba28ULL;
  static const uint64_t static_value2 = 0x68a5e74dd6e8163bULL;
};

template<class ContainerAllocator>
struct DataType< ::px4_uwb::Bspline_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::px4_uwb::Bspline_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::px4_uwb::Bspline_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::px4_uwb::Bspline_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::px4_uwb::Bspline_<ContainerAllocator>& v)
  {
    s << indent << "drone_id: ";
...
#endif // PX4_UWB_MESSAGE_BSPLINE_H
