...
(cl:defmethod cl:initialize-instance :after ((m <Bspline>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bspline)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_uwb-msg:<Bspline> is deprecated: use px4_uwb-msg:Bspline instead.")))

(cl:ensure-generic-function 'drone_id-val :lambda-list '(m))
(cl:defmethod drone_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:drone_id-val is deprecated.  Use px4_uwb-msg:drone_id instead.")
  (drone_id m))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:order-val is deprecated.  Use px4_uwb-msg:order instead.")
  (order m))

(cl:ensure-generic-function 'traj_id-val :lambda-list '(m))
(cl:defmethod traj_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:traj_id-val is deprecated.  Use px4_uwb-msg:traj_id instead.")
  (traj_id m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:start_time-val is deprecated.  Use px4_uwb-msg:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'knots-val :lambda-list '(m))
(cl:defmethod knots-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:knots-val is deprecated.  Use px4_uwb-msg:knots instead.")
  (knots m))

(cl:ensure-generic-function 'pos_pts-val :lambda-list '(m))
(cl:defmethod pos_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:pos_pts-val is deprecated.  Use px4_uwb-msg:pos_pts instead.")
  (pos_pts m))

(cl:ensure-generic-function 'yaw_pts-val :lambda-list '(m))
(cl:defmethod yaw_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:yaw_pts-val is deprecated.  Use px4_uwb-msg:yaw_pts instead.")
  (yaw_pts m))

(cl:ensure-generic-function 'yaw_dt-val :lambda-list '(m))
(cl:defmethod yaw_dt-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:yaw_dt-val is deprecated.  Use px4_uwb-msg:yaw_dt instead.")
  (yaw_dt m))
