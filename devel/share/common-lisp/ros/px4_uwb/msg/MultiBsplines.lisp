...
(cl:defclass <MultiBsplines> (roslisp-msg-protocol:ros-message)
  ((drone_id_from
   ...
   (traj
    :reader traj
    :initarg :traj
    :type (cl:vector px4_uwb-msg:Bspline)
   :initform (cl:make-array 0 :element-type 'px4_uwb-msg:Bspline :initial-element (cl:make-instance 'px4_uwb-msg:Bspline))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MultiBsplines>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiBsplines)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_uwb-msg:<MultiBsplines> is deprecated: use px4_uwb-msg:MultiBsplines instead.")))

(cl:ensure-generic-function 'drone_id_from-val :lambda-list '(m))
(cl:defmethod drone_id_from-val ((m <MultiBsplines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:drone_id_from-val is deprecated.  Use px4_uwb-msg:drone_id_from instead.")
  (drone_id_from m))

(cl:ensure-generic-function 'traj-val :lambda-list '(m))
(cl:defmethod traj-val ((m <MultiBsplines>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_uwb-msg:traj-val is deprecated.  Use px4_uwb-msg:traj instead.")
  (traj m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiBsplines>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'traj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'px4_uwb-msg:Bspline))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MultiBsplines>)))
  ...
  (cl:format cl:nil "int32 drone_id_from~%~%Bspline[] traj~%================================================================================~%MSG: px4_uwb/Bspline~%int32 drone_id~%~%int32 order~%int64 traj_id~%time start_time~%~%float64[] knots~%geometry_msgs/Point[] pos_pts~%~%float64[] yaw_pts~%float64 yaw_dt~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MultiBsplines)))
  "Returns full string definition for message of type 'MultiBsplines"
  (cl:format cl:nil "int32 drone_id_from~%~%Bspline[] traj~%================================================================================~%MSG: px4_uwb/Bspline~%int32 drone_id~%~%int32 order~%int64 traj_id~%time start_time~%~%float64[] knots~%geometry_msgs/Point[] pos_pts~%~%float64[] yaw_pts~%float64 yaw_dt~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
