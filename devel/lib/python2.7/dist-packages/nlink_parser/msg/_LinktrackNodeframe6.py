...
"""autogenerated by genpy from nlink_parser/LinktrackNodeframe6.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe6(genpy.Message):
  ...
  _type = "nlink_parser/LinktrackNodeframe6"
...
"""
  ...
  _slot_types = ['uint8','uint32','nlink_parser/LinktrackNode6[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nlink_parser.msg.LinktrackNode6()
        _x = val1
        start = end
        end += 5
        (_x.role, _x.id,) = _get_struct_BI().unpack(str[start:end])
